...
@section('content')
<section class="hero-element d-flex align-items-center justify-content-evenly py-5">
    <div class="d-flex">
      <img src="{{ asset('front-assets/img/rafiki.png') }}" alt="Hero-Image" />
    </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 d-flex justify-content-center align-items-center">
          <img src="{{ asset('front-assets/img/aboutimg.png') }}" alt="About Image" width="470px" height="413px" class="img-fluid about-img" />
        </div>
        <div class="col-lg-6">
  ...
  <section class="container">
    ...
    <div class="container mb-4 d-flex flex-row gap-3 justify-content-evenly flex-wrap">
      <div class="card mt-2" style="width: 230px; height: 350px">
        <img src="{{ asset('front-assets/img/product.png') }}" class="card-img-top" alt="Product" width="174px" height="189px" />
        <div class="card-body">
          <h5 class="card-title fw-bold">LISENSE GAME ONLINE PES 2017</h5>
          <p class="card-text">Rp. 300.0000</p>
          <a href="#" class="btn btn-primary" style="position: absolute; bottom: 10px; right: 10px">Detail</a>
        </div>
      </div>
      <div class="card mt-2" style="width: 230px; height: 350px">
        <img src="{{ asset('front-assets/img/product.png') }}" class="card-img-top" alt="Product" width="174px" height="189px" />
    ...
    <div class="mt-5 container d-flex justify-content-end">
      <button class="btn px-3 rounded-3" style="background-color: #123159; color: white; font-weight: bold">View All</button>
    </div>
  </section>
        ...
        <div class="col-lg-6 mx-auto">
          <div class="mt-4 d-flex flex-column gap-1">
            ...
            <div class="d-flex flex-row gap-2 align-items-center justify-content-start">
              <a class="fs-5 text-light text-decoration-none"><img src="{{ asset('front-assets/img/facebook.png') }}" alt="Facebook" width="40px" height="39px" style="margin-right: 10px" />Facebook</a>
            </div>
            <div class="d-flex flex-row gap-2 align-items-center justify-content-start">
              <a class="fs-5 text-light text-decoration-none"><img src="{{ asset('front-assets/img/instagram.png') }}" alt="Instagram" width="40px" height="39px" style="margin-right: 10px" />Instagram</a>
            </div>
            <div class="d-flex flex-row gap-2 align-items-center justify-content-start">
              <a class="fs-5 text-light text-decoration-none"><img src="{{ asset('front-assets/img/twiter.png') }}" alt="Twitter" width="40px" height="39px" style="margin-right: 10px" />Twitter</a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 mx-auto">
